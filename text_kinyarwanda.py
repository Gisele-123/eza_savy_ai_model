...
try:
    model = load("soil_scanning/plant_model.pkl")
    scaler = load("soil_scanning/soil_encoder.pkl")  # This should be StandardScaler
    le_plant = load("soil_scanning/plant_encoder.pkl")  # This is LabelEncoder for plant names
...
class BilingualSystem:
    ...
    def predict_and_display(self, R, G, B, top_n=3):
        ...
        try:
            ...
            self.display_message("Sorry, there was an error processing your request.")
