...
scaler = joblib.load('soil_scanning/soil_scaler.pkl')
...
def predict():
    try:
        ...
        # Prepare input dataframe with proper feature names
        input_data = {
            'R': [R],
            'G': [G],
            'B': [B],
        ...
        features = ['R','G','B','Hue','Saturation','Brightness','pH','Temperature','Rainfall','Light_Hours']
